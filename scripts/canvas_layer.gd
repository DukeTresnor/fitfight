...
const player_HEALTH_BAR_X_OFFSET: float = 15.0
const player_HEALTH_BAR_Y_OFFSET: float = 20.0
const player_HEALTH_BAR_X_SCALE_FACTOR: float = 2.0
const player_HEALTH_BAR_Y_SCALE_FACTOR: float = 2.0
...
var target_player_health_bar_coord_x
var target_player_health_bar_coord_y

var target_player_2_health_bar_coord_x
var target_player_2_health_bar_coord_y

var target_player_health_position: Vector2
var target_player_2_health_position: Vector2

var target_player_health_scale: Vector2
...
func _process(delta):
	...
	print("camera_2d: player halth bar location: " + str(player_health_bar.global_position))
	...
	target_player_health_bar_coord_x = viewport_coord_x - viewport_coord_x + player_HEALTH_BAR_X_OFFSET
	target_player_health_bar_coord_y = viewport_coord_y - viewport_coord_y + player_HEALTH_BAR_Y_OFFSET
	...
	target_player_health_position = Vector2( \
			target_player_health_bar_coord_x, \
			target_player_health_bar_coord_y)

	target_player_health_scale = Vector2(player_HEALTH_BAR_X_SCALE_FACTOR, \
				player_HEALTH_BAR_Y_SCALE_FACTOR)
	...
	player_health_bar.set_global_position(target_player_health_position)
	player_health_bar.set_scale(target_player_health_scale)
